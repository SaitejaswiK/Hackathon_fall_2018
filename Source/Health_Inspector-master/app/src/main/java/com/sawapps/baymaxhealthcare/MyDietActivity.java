...
import com.sawapps.baymaxhealthcare.Adapters.MealRecyclerViewAdapter;
...
public class MyDietActivity extends AppCompatActivity {
    ...
    private void getDiet(String calories) {
        ...
        String query = "https://spoonacular-recipe-food-nutrition-v1.p.mashape.com/recipes/mealplans/generate?timeFrame=day&targetCalories=" + calories;
                    ...
                    public void onResponse(Call<GetDietResponse> call, Response<GetDietResponse> response) {
                        try {
                            ...
                            if (response.body().meals != null) {
                                mealsRv.setAdapter(new MealRecyclerViewAdapter(response.body().meals));
